...
import com.cursee.ls_addon_support.seasons.season.wildlife.wildcards.wildcard.trivia.TriviaQuestionManager;
...
public class WildLifeConfig extends ConfigManager {
  ...
  public static final ConfigFileEntry<Double> WILDCARD_HUNGER_SATURATION_CHANCE = new ConfigFileEntry<>(
      ...
      "Saturation Chance",
      "Chance for food to have saturation (needs to have nutrition to have saturation too btw)."
  );
  ...
  public static final ConfigFileEntry<Double> WILDCARD_TIMEDILATION_PLAYER_MAX_SPEED = new ConfigFileEntry<>(
      ...
      "Controls the maximum speed the PLAYERS themselves can move (not the world)."
  );
  ...
  public static final ConfigFileEntry<Integer> WILDCARD_TRIVIA_BOTS_PER_PLAYER = new ConfigFileEntry<>(
      ...
      "Trivia Bots per Player",
      "The amount of trivia bots that will spawn for each player over the session."
  );
  ...
  public static final ConfigFileEntry<Integer> WILDCARD_MOBSWAP_START_SPAWN_DELAY = new ConfigFileEntry<>(
      ...
      "Session Start Spawn Delay",
      "The delay between mob spawns at the START of the session, in seconds."
  );
  public static final ConfigFileEntry<Integer> WILDCARD_MOBSWAP_END_SPAWN_DELAY = new ConfigFileEntry<>(
      ...
      "Session End Spawn Delay",
      "The delay between mob spawns at the END of the session, in seconds."
  );
  ...
  public static final ConfigFileEntry<Integer> WILDCARD_SUPERPOWERS_WINDCHARGE_MAX_MACE_DAMAGE = new ConfigFileEntry<>(
      ...
      "Wind Charge: Max Mace Damage",
      "The max amount of damage you can deal with a mace while using the Wind Charge superpower."
  );
  public static final ConfigFileEntry<Boolean> WILDCARD_SUPERPOWERS_ZOMBIES_LOSE_ITEMS = new ConfigFileEntry<>(
      ...
      "Necromancy: Zombies Lose Items",
      "Controls whether zombies keep their items when they first get respawned."
  );
  public static final ConfigFileEntry<Boolean> WILDCARD_SUPERPOWERS_ZOMBIES_REVIVE_BY_KILLING_DARK_GREEN = new ConfigFileEntry<>(
      ...
      "Necromancy: Zombies Can Revive",
      "Controls whether zombies can be revived (gain a life) by killing a dark green player."
  );
  public static final ConfigFileEntry<Boolean> WILDCARD_SUPERPOWERS_SUPERSPEED_STEP = new ConfigFileEntry<>(
      ...
      "Superspeed: Step Up Blocks",
      "Controls whether players with the superspeed power active can step up blocks without jumping (like when riding a horse)."
  );
  public static final ConfigFileEntry<Boolean> WILDCARD_SUPERPOWERS_DISABLE_INTRO_THEME = new ConfigFileEntry<>(
      ...
      "Superspeed: Disable Intro Theme",
      "Disables the theme music that plays when this wildcard is activated."
  );
  public static final ConfigFileEntry<String> WILDCARD_SUPERPOWERS_POWER_BLACKLIST = new ConfigFileEntry<>(
      ...
      "Blacklisted Powers", "List of superpowers that cannot be rolled randomly.",
      Superpowers.getAllStr()
  );


  public static final ConfigFileEntry<String> WILDCARD_CALLBACK_WILDCARDS_BLACKLIST = new ConfigFileEntry<>(
      "wildcard_callback_wildcards_blacklist", "[hunger]", ConfigTypes.STRING_LIST,
      "season.callback",
      "Blacklisted Wildcards", "List of wildcards that cannot be activated in Callback.",
      Wildcards.getWildcardsStr()
  );
  public static final ConfigFileEntry<Double> WILDCARD_CALLBACK_TURN_OFF = new ConfigFileEntry<>(
      ...
      "Turn Off In Session",
      "Controls when in the session the callback wildcard turns off (percentage)."
  );
  ...
  public static final ConfigFileEntry<Double> ACTIVATE_WILDCARD_MINUTE = new ConfigFileEntry<>(
      ...
      "Activate Wildcard Time",
      "The number of minutes (in the session) after which the wildcard is activated."
  );
  public static final ConfigFileEntry<Boolean> KILLING_DARK_GREENS_GAINS_LIVES = new ConfigFileEntry<>(
      ...
      "Killing Dark Greens Gains Lives",
      "Controls whether killing dark green players (4+ lives) gives the killer a life."
  );
  public static final ConfigFileEntry<Boolean> BROADCAST_LIFE_GAIN = new ConfigFileEntry<>(
      ...
      "Broadcast Life Gain",
      "Shows a message in chat when a player gains a life by killing a dark green player."
  );

  public WildLifeConfig() {
    super("./config/" + LSAddonSupport.MOD_ID, "wildlife.properties");
  }
