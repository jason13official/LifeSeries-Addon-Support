...
public class SocietyCommands {
  ...
  public static boolean checkBanned(ServerCommandSource source) {
    ...
    source.sendError(Text.of(
        "This command is only available when the Secret Society has been enabled in the Life Series config."));
    return true;
  }
        ...
        literal("society")
            ...
            .then(literal("begin")
                ...
                .then(argument("secret_word", StringArgumentType.string())
                    .executes(context -> societyBegin(context.getSource(),
                        StringArgumentType.getString(context, "secret_word")))
                )
