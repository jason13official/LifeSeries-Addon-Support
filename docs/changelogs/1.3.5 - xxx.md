...
You can also choose the min/max amount of boogeymen, along with the multiplier (in the config).<br>
You can prevent certain players from becoming the boogeyman & force players to become the boogeyman (in the config).